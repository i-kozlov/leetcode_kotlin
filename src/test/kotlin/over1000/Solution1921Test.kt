...
class Solution1921Test {
    ...
    fun eliminateMaximum() {
        ...
        assertEquals(2, solution.eliminateMaximum(intArrayOf(1, 3, 4), intArrayOf(1, 1, 2)))
        assertEquals(3, solution.eliminateMaximum(intArrayOf(3, 5, 7, 4, 5), intArrayOf(2, 3, 6, 3, 2)))
